...
public class CheckWinner : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        {
            Vector3 desiredPosition = new Vector3(target.position.x + 2.2f, target.position.y, target.position.z + 2.2f);
        ...
        }/* playerRotation.position.x, playerRotation.position.y, winnerCamera.transform.position.z */
    }
